df_s = sqlContext.read.load('population.csv', format='com.databricks.spark.csv', header='true', inferSchema='true')
df_c = sqlContext.read.load('population_count.csv', format='com.databricks.spark.csv', header='true', inferSchema='true')
